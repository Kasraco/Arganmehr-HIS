...
namespace ServiceLayer.Localization
{
    public class LocalizedEntityService : ILocalizedEntityService
    {
        ...
        private const string LOCALIZEDPROPERTY_KEY = "Arganmher.localizedproperty.value-{0}-{1}-{2}-{3}";
        private const string LOCALIZEDPROPERTY_ALL_KEY = "Arganmher.localizedproperty.all";
        private const string LOCALIZEDPROPERTY_PATTERN_KEY = "Arganmher.localizedproperty.";

        #endregion

        #region Fields

        private readonly IDbSet<LocalizedProperty> _localizedPropertyRepository;
        ...
        public LocalizedEntityService(ICacheManagerKRB cacheManager, IUnitOfWork uow, LocalizationSettings localizationSettings)
        {
            _uow = uow;
            this._cacheManager = cacheManager;
            this._localizedPropertyRepository = _uow.Set<LocalizedProperty>();
        ...
        public virtual LocalizedProperty GetLocalizedPropertyById(int localizedPropertyId)
        {
            ...
            var localizedProperty = _localizedPropertyRepository.Find(localizedPropertyId);
        ...
        public virtual string GetLocalizedValue(int languageId, int entityId, string localeKeyGroup, string localeKey)
        {
            ...
            if (_localizationSettings.LoadAllLocalizedPropertiesOnStartup)
            {
                ...
                {
                    var result = _localizedPropertyRepository.AsQueryable().ToDictionary(
            ...
            else
            {
                ...
                {
                    var query = from lp in _localizedPropertyRepository.AsQueryable()
