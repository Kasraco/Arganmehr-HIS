...
namespace ServiceLayer.Contracts
{
    ...
    public interface IApplicationUserManager : IDisposable
    {
        ...
        void SeedDatabase();
        Task<EditUserViewModel> GetUserByRolesAsync(long id);
        IList<UserViewModel> GetPageList(out int total, UserSearchRequest search);
        ...
        Task<long> CreateAsync(RegisterViewModel viewModel);
