...
namespace IocConfig.Theming
{
    public partial class DefaultThemeRegistry : DisposableObject, IThemeRegistry
    {
        ...
        {
            this._enableMonitoring = enableMonitoring ?? CommonHelper.GetAppSetting("am:MonitorThemesFolder", true);
            this._themesBasePath = themesBasePath.NullEmpty() ?? CommonHelper.GetAppSetting<string>("am:ThemesBasePath", "~/Themes/").EnsureEndsWith("/");
        ...
        public void ReloadThemes()
        {
            ...
            var folder = ProjectObjectFactory.Container.GetInstance<IWebSiteFolder>();
