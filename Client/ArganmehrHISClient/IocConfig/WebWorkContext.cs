...
namespace IocConfig
{
    ...
    {
        private const string UserCookieName = "arganmehr.client";
        ...
        private InstitutionModel _cachedInstitution;
        ...
        public InstitutionModel CurrentInstitution
        {
            get
            {
                if (_cachedInstitution != null)
                    return _cachedInstitution;
                _cachedInstitution = _institutionService.GetInstitution();
                if (_cachedInstitution == null)
                {
                    var ca = _caService.GetFirstCentralAdmin();
                    if (ca == null)
                        return null;
                    else
                    {
