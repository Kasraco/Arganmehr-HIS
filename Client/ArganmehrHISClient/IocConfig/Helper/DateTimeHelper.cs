...
namespace IocConfig.Helper
{
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        public DateTimeHelper(IWorkContext workContext,
            ...
            ISettingServices settingService,
        ...
        public virtual TimeZoneInfo GetCustomerTimeZone(User customer)
        {
            //registered user
            ...
            if (_dateTimeSettings.AllowCustomersToSetTimeZone)
            {
                ...
                if (customer != null)
                    timeZoneId = customer.GetAttribute<string>("TimeZoneId", _genericAttributeService);
