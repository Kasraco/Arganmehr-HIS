...
namespace IocConfig
{
      ...
      IConsumer<ThemeTouchedEvent>
    {
        ...
        /// {1} : store identifier
        /// </remarks>
        public const string THEMEVARS_LESSCSS_KEY = "amclient.pres.themevars-lesscss-{0}-{1}";
        public const string THEMEVARS_LESSCSS_THEME_KEY = "amclient.pres.themevars-lesscss-{0}";
        ...
        /// {1} : store identifier
        /// </remarks>
        public const string CUSTOMERROLES_TAX_DISPLAY_TYPES_KEY = "amclient.fw.customerroles.taxdisplaytypes-{0}-{1}";
        public const string CUSTOMERROLES_TAX_DISPLAY_TYPES_PATTERN_KEY = "amclient.fw.customerroles.taxdisplaytypes";
