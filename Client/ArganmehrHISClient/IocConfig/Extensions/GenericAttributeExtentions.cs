...
namespace IocConfig.Extensions
{
    public static class GenericAttributeExtentions
    {
        ...
        public static TPropType GetAttribute<TPropType>(this User entity, string key, int storeId = 0)
        {
            var genericAttributeService =ProjectObjectFactory.Container.GetInstance<IGenericAttributeService>();
        ...
        /// <param name="storeId">Load a value specific for a certain store; pass 0 to load a value shared for all stores</param>
        /// <returns>Attribute</returns>
        public static TPropType GetAttribute<TPropType>(this User entity,
            string key, IGenericAttributeService genericAttributeService, int storeId = 0)
        {
            ...
            if (genericAttributeService == null)
                genericAttributeService = ProjectObjectFactory.Container.GetInstance<IGenericAttributeService>();
        ...
        public static TPropType GetAttribute<TPropType>(this IGenericAttributeService genericAttributeService, string entityName, long entityId, string key, int storeId = 0)
        {
