...
namespace Common.Helpers.Extentions
{
    public static class StringExtensions
    {
        ...
        [DebuggerStepThrough]
        public static string GenerateCode(this string value,int LengthCode)
        {
            return GenerateRandomPassword(LengthCode);
        }
        ...
        {
            EncrypedString ES = new EncrypedString();
            return ES.Encrypt(value);
        }
        [DebuggerStepThrough]
        public static string StringDecode(this string value)
        {
            EncrypedString ES = new EncrypedString();
