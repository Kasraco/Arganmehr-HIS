...
namespace IocConfig.UI
{
    public static class ScaffoldExtensions
    {
        ...
        public static System.Web.WebPages.HelperResult SymbolForBool<T>(this HtmlHelper<T> helper, bool value)
        {
            return new System.Web.WebPages.HelperResult(writer => writer.Write("<i class='fa fa-fw icon-active-{0}'></i>".FormatInvariant(value.ToString().ToLower())));
        }
        ...
        public static System.Web.WebPages.HelperResult LabeledProductName<T>(this HtmlHelper<T> helper, int id, string name, string typeName, string typeLabelHint)
        {
            ...
            return new System.Web.WebPages.HelperResult(writer => writer.Write("<span class='label label-smnet label-{0}'>{1}</span>{2}".FormatInvariant(typeLabelHint, typeName, namePart)));
        }

        public static string LabeledOrderNumber<T>(this HtmlHelper<T> helper)
        {
            var localize = ProjectObjectFactory.Container.GetInstance<ILocalizationService>();
        ...
        public static System.Web.WebPages.HelperResult LabeledCurrencyName<T>(this HtmlHelper<T> helper, int id, string name, bool isPrimaryStoreCurrency, bool isPrimaryExchangeRateCurrency)
        {
            var localize = ProjectObjectFactory.Container.GetInstance<ILocalizationService>();
            ...
            return new System.Web.WebPages.HelperResult(writer => writer.Write(sb.ToString()));
        }
